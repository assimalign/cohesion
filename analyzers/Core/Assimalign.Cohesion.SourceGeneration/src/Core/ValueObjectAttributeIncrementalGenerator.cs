...
[Generator]
public class ValueObjectAttributeIncrementalGenerator : IIncrementalGenerator
{

    private const string fqmd = "System.ValueObjectAttribute";
                ...
                if (attribute is not null && attribute.ArgumentList is not null)
                {
                    ...
                    foreach (var argument in arguments)
                    {
                        if (argument.Expression is MemberAccessExpressionSyntax member &&
                            ...
                            identifier.ToString() == "ValueObjectRuntimeType")
                        {
