...
The area root owns only the contracts that feature packages compose against. `IEventHubApplicationBuilder` is the contract-only builder seam, while `IEventHubApplication` supplies the hosting-free application lifecycle.
