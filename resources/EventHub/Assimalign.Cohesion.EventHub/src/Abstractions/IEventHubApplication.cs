...
/// <summary>
/// Represents the EventHub application lifecycle without hosting dependencies.
/// </summary>
public interface IEventHubApplication
{
    /// <summary>
    /// Gets the application context.
    /// </summary>
    IEventHubApplicationContext Context { get; }
