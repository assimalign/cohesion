...
/// <summary>
/// Provides the EventHub application environment and runtime composition.
/// </summary>
public sealed class EventHubApplicationContext : HostContext, IEventHubApplicationContext, IHealthContributor
{
