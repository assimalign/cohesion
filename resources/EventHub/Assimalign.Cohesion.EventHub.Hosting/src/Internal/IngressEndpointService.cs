...
internal sealed class IngressEndpointService : BackgroundService
{
    protected override async Task ExecuteAsync(CancellationToken cancellationToken)
    {
        // TODO: accept event ingress connections. The placeholder parks until the host stops so the scaffolded
