...
public sealed class ResourceControlPlaneTests
{
    ...
    public async Task ControlPlane_WithEndpoint_ShouldServeProbesAndManagement(bool managed)
    {
        ...
        await using EventHubApplication application = CreateBuilder(typeof(ResourceControlPlaneTests).Assembly).Build();
    ...
    public async Task Build_WithoutRegistration_ShouldLeaveHostUnconfigured()
    {
        ...
        await using EventHubApplication application = CreateBuilder(typeof(EventHubApplication).Assembly).Build();
    ...
    private static EventHubApplicationBuilder CreateBuilder(Assembly assembly)
    {
        ...
        return (EventHubApplicationBuilder)method.Invoke(null, [Array.Empty<string>(), assembly])!;
    }
