...
internal sealed class ProxyDataPlaneService : IHostService
{
    ...
    public Task StartAsync(CancellationToken cancellationToken = default)
    {
        ...
        for (var index = 0; index < threadCount; index++)
        {
            ...
            {
                IsBackground = true,
                Name = $"ProxyDataPlaneService:{core}",
            };
    ...
    {
        // TODO: pin and run this core's loop to proxy connections across backends. The placeholder blocks until the
