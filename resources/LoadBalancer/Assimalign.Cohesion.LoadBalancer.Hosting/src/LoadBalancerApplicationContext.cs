...
/// <summary>
/// The host context for <see cref="LoadBalancerApplication"/>.
/// </summary>
public sealed class LoadBalancerApplicationContext : HostContext
{
    private readonly IHostEnvironment _environment;
    private readonly IReadOnlyList<IHostService> _hostedServices;

    internal LoadBalancerApplicationContext(LoadBalancerApplicationOptions options, IReadOnlyList<IHostService> hostedServices)
    {
