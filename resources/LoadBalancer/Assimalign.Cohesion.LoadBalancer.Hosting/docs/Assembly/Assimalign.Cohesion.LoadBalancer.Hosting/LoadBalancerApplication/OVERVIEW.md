...
`LoadBalancerApplication` is the public concrete application and creation entry point for the load balancer hosting module. The application, builder, and context are public; runtime options remain internal.
