...
public sealed class ResourceControlPlaneTests
{
    ...
    [Theory(DisplayName = "Cohesion Test [LoadBalancer.Hosting] - Control plane: managed and standalone resource routes")]
    [InlineData(true)]
    [InlineData(false)]
    ...
    [Fact(DisplayName = "Cohesion Test [LoadBalancer.Hosting] - Unregistered resource: builds the plain host without a listener")]
