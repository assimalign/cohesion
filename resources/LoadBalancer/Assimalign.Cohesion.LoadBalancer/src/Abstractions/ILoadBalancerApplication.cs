...
/// <summary>
/// Represents the LoadBalancer application lifecycle without hosting dependencies.
/// </summary>
public interface ILoadBalancerApplication
{
    /// <summary>
    /// Gets the application context.
    /// </summary>
    ILoadBalancerApplicationContext Context { get; }
