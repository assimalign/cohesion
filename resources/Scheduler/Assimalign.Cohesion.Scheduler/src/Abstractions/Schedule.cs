    ...
    where TContext : IScheduleContext
{
    ...
    private sealed class OccurrenceStartGate
    {
        private readonly object _sync = new();
        private bool _cancellationRequested;

        /// <summary>
        /// Initializes a new instance of the <see cref="OccurrenceStartGate"/> class.
        /// </summary>
        /// <param name="cancellationRequested">Whether start cancellation was already requested when the gate was created.</param>
        public OccurrenceStartGate(bool cancellationRequested)
        {
