...
public sealed class ResourceControlPlaneTests
{
    ...
    public async Task ControlPlane_WithEndpoint_ShouldServeProbesAndManagement(bool managed)
    {
        ...
        await using VpnGatewayApplication application = CreateBuilder(typeof(ResourceControlPlaneTests).Assembly).Build();
    ...
    public async Task Build_WithoutRegistration_ShouldLeaveHostUnconfigured()
    {
        ...
        await using VpnGatewayApplication application = CreateBuilder(typeof(VpnGatewayApplication).Assembly).Build();
    ...
    private static VpnGatewayApplicationBuilder CreateBuilder(Assembly assembly)
    {
        ...
        return (VpnGatewayApplicationBuilder)method.Invoke(null, [Array.Empty<string>(), assembly])!;
    }
