...
/// <summary>
/// The host context for <see cref="VpnGatewayApplication"/>.
/// </summary>
public sealed class VpnGatewayApplicationContext : HostContext
{
    private readonly IHostEnvironment _environment;
    private readonly IReadOnlyList<IHostService> _hostedServices;

    internal VpnGatewayApplicationContext(VpnGatewayApplicationOptions options, IReadOnlyList<IHostService> hostedServices)
    {
