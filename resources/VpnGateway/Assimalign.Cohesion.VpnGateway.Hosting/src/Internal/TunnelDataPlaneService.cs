...
internal sealed class TunnelDataPlaneService : IHostService
{
    ...
    public Task StartAsync(CancellationToken cancellationToken = default)
    {
        ...
        for (var index = 0; index < threadCount; index++)
        {
            ...
            {
                IsBackground = true,
                Name = $"TunnelDataPlaneService:{core}",
            };
    ...
    {
        // TODO: pin and run this core's loop to encrypt and forward tunnel traffic. The placeholder blocks until the
