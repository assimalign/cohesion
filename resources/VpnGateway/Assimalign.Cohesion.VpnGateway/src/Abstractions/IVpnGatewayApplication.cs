...
/// <summary>
/// Represents the VpnGateway application lifecycle without hosting dependencies.
/// </summary>
public interface IVpnGatewayApplication
{
    /// <summary>
    /// Gets the application context.
    /// </summary>
    IVpnGatewayApplicationContext Context { get; }
