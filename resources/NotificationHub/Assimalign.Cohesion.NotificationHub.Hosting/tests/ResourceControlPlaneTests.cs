...
public sealed class ResourceControlPlaneTests
{
    ...
    public async Task ControlPlane_WithEndpoint_ShouldServeProbesAndManagement(bool managed)
    {
        ...
        await using NotificationHubApplication application = CreateBuilder(typeof(ResourceControlPlaneTests).Assembly).Build();
    ...
    public async Task Build_WithoutRegistration_ShouldLeaveHostUnconfigured()
    {
        ...
        await using NotificationHubApplication application = CreateBuilder(typeof(NotificationHubApplication).Assembly).Build();
    ...
    private static NotificationHubApplicationBuilder CreateBuilder(Assembly assembly)
    {
        ...
        return (NotificationHubApplicationBuilder)method.Invoke(null, [Array.Empty<string>(), assembly])!;
    }
