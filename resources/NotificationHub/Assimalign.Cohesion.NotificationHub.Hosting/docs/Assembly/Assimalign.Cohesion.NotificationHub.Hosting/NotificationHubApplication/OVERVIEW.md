...
- Building the returned builder materializes its registered service factories once against the new NotificationHub context and preserves registration order; no services are added by default.
