...
/// <summary>
/// Provides the LogSpace application environment and runtime composition.
/// </summary>
public sealed class LogSpaceApplicationContext : HostContext, ILogSpaceApplicationContext, IHealthContributor
{
