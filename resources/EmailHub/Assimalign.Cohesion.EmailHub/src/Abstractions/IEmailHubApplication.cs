...
/// <summary>
/// Represents the EmailHub application lifecycle without hosting dependencies.
/// </summary>
public interface IEmailHubApplication
{
    /// <summary>
    /// Gets the application context.
    /// </summary>
    IEmailHubApplicationContext Context { get; }
