...
public sealed class ResourceControlPlaneTests
{
    ...
    public async Task ControlPlane_WithEndpoint_ShouldServeProbesAndManagement(bool managed)
    {
        ...
        await using EmailHubApplication application = CreateBuilder(typeof(ResourceControlPlaneTests).Assembly).Build();
    ...
    public async Task Build_WithoutRegistration_ShouldLeaveHostUnconfigured()
    {
        ...
        await using EmailHubApplication application = CreateBuilder(typeof(EmailHubApplication).Assembly).Build();
    ...
    private static EmailHubApplicationBuilder CreateBuilder(Assembly assembly)
    {
        ...
        return (EmailHubApplicationBuilder)method.Invoke(null, [Array.Empty<string>(), assembly])!;
    }
