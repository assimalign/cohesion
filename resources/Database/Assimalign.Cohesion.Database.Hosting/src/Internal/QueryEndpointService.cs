...
internal sealed class QueryEndpointService : BackgroundService
{
    protected override async Task ExecuteAsync(CancellationToken cancellationToken)
    {
        // TODO: accept query connections. The placeholder parks until the host stops so the scaffolded
