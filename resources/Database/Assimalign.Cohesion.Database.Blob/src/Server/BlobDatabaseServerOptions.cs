...
/// <summary>
/// Options controlling the Blob database server front-end: the transport
...
/// through <see cref="BlobDatabaseServer.Create"/>.
/// </remarks>
public sealed class BlobDatabaseServerOptions
{
    /// <summary>
