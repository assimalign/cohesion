...
internal sealed class BlobWriteStream : Stream
{
    ...
    /// <summary>Initializes a new instance of the <see cref="BlobWriteStream"/> class.</summary>
    /// <param name="storage">The blob storage that receives the persisted content chunks.</param>
