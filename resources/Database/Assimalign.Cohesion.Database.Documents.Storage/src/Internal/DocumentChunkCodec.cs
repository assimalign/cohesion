...
internal static class DocumentChunkCodec
{
    ...
    internal static (ulong Next, ReadOnlyMemory<byte> Payload) Decode(ReadOnlyMemory<byte> bytes, long remaining)
    {
        ...
        {
            throw new StorageCorruptionException("Invalid document chunk header.");
        }
        ...
        {
            throw new StorageCorruptionException("Document chunk length or next location disagrees with catalog length.");
        }
...
internal static class DocumentContentChecksum
{
