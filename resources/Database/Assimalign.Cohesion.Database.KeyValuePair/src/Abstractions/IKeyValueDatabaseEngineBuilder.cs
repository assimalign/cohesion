...
/// <summary>Captures key-value engine options and deferred worker and server factories.</summary>
public interface IKeyValueDatabaseEngineBuilder : IDatabaseEngineBuilder
{
    ...
    IKeyValueStorageStrategy? StorageStrategy { get; set; }
