...
public static class KeyValueDatabaseApplicationExtensions
{
    extension(IDatabaseApplicationBuilder builder)
    {
        ...
        /// <param name="configure">Configures the server options; must supply the <see cref="KeyValueDatabaseServerOptions.Listener"/> whose lifecycle transfers to the server.</param>
        /// <returns>
