...
public interface IDatabaseResourceDescriptor : IResourceCommandDescriptor
{
    ...
    new IDatabaseResourceDescriptor DependsOn(IApplicationResourceDescriptor resource);
    ...
    /// <exception cref="System.InvalidOperationException">A self dependency is declared or the model is built.</exception>
    new IDatabaseResourceDescriptor DependsOn(params IApplicationResourceDescriptor[] resources);
}