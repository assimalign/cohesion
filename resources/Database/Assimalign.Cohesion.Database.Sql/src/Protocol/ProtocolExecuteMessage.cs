...
/// <summary>
/// The SQL execute request: statement text plus named parameter values.
/// Each value uses one component of the shared scalar tuple codec; this
/// request shape belongs to the SQL family.
/// </summary>
...
public sealed record ProtocolExecuteMessage(string Statement, IReadOnlyDictionary<string, byte[]> Parameters)
{
    ...
    /// </summary>
    /// <returns>The payload bytes for a <see cref="SqlProtocolMessageType.Execute"/> frame.</returns>
    public byte[] Encode()
    {
