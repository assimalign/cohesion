...
public interface ISqlSchemaBuilder
{
    ...
    void Type<T>(Action<ISqlTypeBuilder> configure);
    ...
    /// <exception cref="ArgumentNullException"><paramref name="configure"/> is null.</exception>
    void Table<T>(Action<ISqlTableBuilder<T>> configure);
    ...
    /// <exception cref="ArgumentNullException"><paramref name="configure"/> is null.</exception>
    void Table<T>(string name, Action<ISqlTableBuilder<T>> configure);
    ...
    void Principal(string name, Action<ISqlPrincipalBuilder> configure);
}
