...
/// <summary>Represents an immutable, validated database schema bound to one engine model.</summary>
public sealed class CompiledSchema
{
    ...
    /// <param name="collections">The key-value collections.</param>
        ...
        IReadOnlyList<CompiledSchemaExtension> extensions)
    {
        ...
        Collections = Snapshot(collections, "schema.collections", static value => value.Name);
        ...
        CompiledSchemaValidator.Validate(this);
    }

    /// <summary>Gets the document format.</summary>
    public string Format { get; }

    /// <summary>Gets the logical database name.</summary>
    public string Name { get; }

    /// <summary>Gets the engine model whose dialect owns the schema.</summary>
    public EngineModel Model { get; }

    /// <summary>Gets a value indicating whether destructive migrations are permitted.</summary>
    ...
    /// <summary>Gets the key-value collections in stable name order.</summary>
    public IReadOnlyList<CompiledSchemaCollection> Collections { get; }
    ...
    /// <summary>Gets the lowercase SHA-256 hash of the canonical document.</summary>
    [JsonIgnore]
    public string Hash => CompiledSchemaSerializer.ComputeHash(this);
...
/// <summary>Describes a compiled table column or collection field.</summary>
/// <param name="Name">The column or field name.</param>
...
/// <summary>Describes a compiled key-value collection.</summary>
/// <param name="Name">The stable collection name.</param>
/// <param name="EntryType">The stable CLR entry type identifier.</param>
/// <param name="Fields">The ordered fields.</param>
/// <param name="Key">The collection key.</param>
/// <param name="Indexes">The secondary indexes.</param>
public sealed record CompiledSchemaCollection(
    string Name,
    string EntryType,
    IReadOnlyList<CompiledSchemaColumn> Fields,
    CompiledSchemaKey? Key,
    IReadOnlyList<CompiledSchemaIndex> Indexes)
{
    /// <summary>Gets the immutable ordered fields.</summary>
    public IReadOnlyList<CompiledSchemaColumn> Fields { get; } = CompiledSchemaSnapshots.Copy(Fields);

    /// <summary>Gets the immutable secondary indexes.</summary>
    public IReadOnlyList<CompiledSchemaIndex> Indexes { get; } = CompiledSchemaSnapshots.CopySorted(
        Indexes,
        static (left, right) => StringComparer.Ordinal.Compare(left.Name, right.Name));
}
...
public sealed record CompiledSchemaGrant(Permission Permission, IReadOnlyList<string> Objects)
{
