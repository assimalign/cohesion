...
public sealed class GraphDatabaseEngine : IDatabaseEngine
{
    ...
    private GraphDatabaseEngine(GraphDatabaseEngineOptions options)
    {
        ...
        _workers = [new GraphWriteAheadFlushWorker(this, _commitPending), new GraphPageWriteBackWorker(this),
            new GraphCheckpointWorker(this), new GraphVersionPurgeWorker(this)];
    ...
    public void Dispose()
    {
        ...
        {
            throw new AggregateException("One or more graph databases failed to close.", errors);
        }
    }
