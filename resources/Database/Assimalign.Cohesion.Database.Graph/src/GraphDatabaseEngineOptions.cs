...
public sealed class GraphDatabaseEngineOptions
{
    ...
    /// Graph mutations use nondurable physical brackets followed by the shared
    /// coordinator's synchronous durable logical commit. Logical graph commits
    ...
    /// and the flush worker's wake cadence. Logical graph commits flush
    ...
    /// open database's file set (metadata, graph records and indexes) are durably flushed and their
    /// journals truncated.
    /// </summary>
