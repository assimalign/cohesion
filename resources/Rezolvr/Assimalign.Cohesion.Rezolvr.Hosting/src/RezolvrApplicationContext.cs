...
/// <summary>
/// The host context for <see cref="RezolvrApplication"/>.
/// </summary>
public sealed class RezolvrApplicationContext : HostContext
{
    private readonly IHostEnvironment _environment;
    private readonly IReadOnlyList<IHostService> _hostedServices;

    internal RezolvrApplicationContext(RezolvrApplicationOptions options, IReadOnlyList<IHostService> hostedServices)
    {
