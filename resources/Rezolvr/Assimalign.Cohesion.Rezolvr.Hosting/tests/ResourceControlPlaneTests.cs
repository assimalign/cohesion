...
public sealed class ResourceControlPlaneTests
{
    ...
    public async Task ControlPlane_WithEndpoint_ShouldServeProbesAndManagement(bool managed)
    {
        ...
        await using RezolvrApplication application = CreateBuilder(typeof(ResourceControlPlaneTests).Assembly).Build();
    ...
    public async Task Build_WithoutRegistration_ShouldLeaveHostUnconfigured()
    {
        ...
        await using RezolvrApplication application = CreateBuilder(typeof(RezolvrApplication).Assembly).Build();
    ...
    private static RezolvrApplicationBuilder CreateBuilder(Assembly assembly)
    {
        ...
        return (RezolvrApplicationBuilder)method.Invoke(null, [Array.Empty<string>(), assembly])!;
    }
