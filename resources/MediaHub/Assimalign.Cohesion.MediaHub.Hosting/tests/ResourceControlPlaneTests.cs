...
public sealed class ResourceControlPlaneTests
{
    ...
    public async Task ControlPlane_WithEndpoint_ShouldServeProbesAndManagement(bool managed)
    {
        ...
        await using MediaHubApplication application = CreateBuilder(typeof(ResourceControlPlaneTests).Assembly).Build();
    ...
    public async Task Build_WithoutRegistration_ShouldLeaveHostUnconfigured()
    {
        ...
        await using MediaHubApplication application = CreateBuilder(typeof(MediaHubApplication).Assembly).Build();
    ...
    private static MediaHubApplicationBuilder CreateBuilder(Assembly assembly)
    {
        ...
        return (MediaHubApplicationBuilder)method.Invoke(null, [Array.Empty<string>(), assembly])!;
    }
