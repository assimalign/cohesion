...
/// <summary>
/// Provides the MediaHub application environment and runtime composition.
/// </summary>
public sealed class MediaHubApplicationContext : HostContext, IMediaHubApplicationContext, IHealthContributor
{
