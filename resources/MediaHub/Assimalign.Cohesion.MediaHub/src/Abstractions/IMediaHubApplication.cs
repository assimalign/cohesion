...
/// <summary>
/// Represents the MediaHub application lifecycle without hosting dependencies.
/// </summary>
public interface IMediaHubApplication
{
    /// <summary>
    /// Gets the application context.
    /// </summary>
    IMediaHubApplicationContext Context { get; }
