...
/// <summary>
/// Provides the ApiManager application environment and runtime composition.
/// </summary>
public sealed class ApiManagerApplicationContext : HostContext, IApiManagerApplicationContext, IHealthContributor
{
    private IReadOnlyList<IHostService> _hostedServices = Array.Empty<IHostService>();
    private readonly IHostEnvironment _environment;

    internal ApiManagerApplicationContext(ResourceContext? resourceContext = null)
    {
    ...
    public ValueTask<HealthContribution> CheckAsync(CancellationToken cancellationToken = default)
    {
        ...
        return ValueTask.FromResult(State is HostState.Failed
            ? HealthContribution.Unhealthy("The ApiManager host failed.")
