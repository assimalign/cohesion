...
/// <summary>
/// The host context for <see cref="ApiManagerApplication"/>.
/// </summary>
public sealed class ApiManagerApplicationContext : HostContext
{
    private readonly IHostEnvironment _environment;
    private readonly IReadOnlyList<IHostService> _hostedServices;

    internal ApiManagerApplicationContext(ApiManagerApplicationOptions options, IReadOnlyList<IHostService> hostedServices)
    {
