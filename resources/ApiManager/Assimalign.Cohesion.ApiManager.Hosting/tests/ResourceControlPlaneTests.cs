...
public sealed class ResourceControlPlaneTests
{
    ...
    [Theory(DisplayName = "Cohesion Test [ApiManager.Hosting] - Control plane: managed and standalone resource routes")]
    [InlineData(true)]
    [InlineData(false)]
    ...
    [Fact(DisplayName = "Cohesion Test [ApiManager.Hosting] - Unregistered resource: builds the plain host without a listener")]
