...
The area root owns only the contracts that feature packages compose against. `IApiManagerApplicationBuilder` is the contract-only builder seam, while `IApiManagerApplication` supplies the hosting-free application lifecycle.
