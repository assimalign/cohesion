...
/// <summary>
/// Represents the SecretStore application lifecycle without hosting dependencies.
/// </summary>
public interface ISecretStoreApplication
{
    /// <summary>
    /// Gets the application context.
    /// </summary>
    ISecretStoreApplicationContext Context { get; }
