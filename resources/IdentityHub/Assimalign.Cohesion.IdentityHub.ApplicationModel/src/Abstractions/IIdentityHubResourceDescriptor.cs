...
public interface IIdentityHubResourceDescriptor : IResourceCommandDescriptor
{
    ...
    new IdentityHubResource Resource { get; }
    ...
    new IIdentityHubResourceDescriptor DependsOn(IApplicationResourceDescriptor resource);
    ...
    /// <exception cref="System.InvalidOperationException">A self dependency is declared or the model is built.</exception>
    new IIdentityHubResourceDescriptor DependsOn(params IApplicationResourceDescriptor[] resources);
}
