...
internal sealed class IdentityEndpointService : BackgroundService
{
    protected override async Task ExecuteAsync(CancellationToken cancellationToken)
    {
        // TODO: serve identity, token, and session requests. The placeholder parks until the host stops so the scaffolded
