...
/// <summary>
/// Represents the IdentityHub application lifecycle without hosting dependencies.
/// </summary>
public interface IIdentityHubApplication
{
    /// <summary>
    /// Gets the application context.
    /// </summary>
    IIdentityHubApplicationContext Context { get; }
