...
/// <summary>
/// Provides the MessageHub application environment and runtime composition.
/// </summary>
public sealed class MessageHubApplicationContext : HostContext, IMessageHubApplicationContext, IHealthContributor
{
