...
public sealed class ResourceControlPlaneTests
{
    ...
    public async Task ControlPlane_WithEndpoint_ShouldServeProbesAndManagement(bool managed)
    {
        ...
        await using MessageHubApplication application = CreateBuilder(typeof(ResourceControlPlaneTests).Assembly).Build();
    ...
    public async Task Build_WithoutRegistration_ShouldLeaveHostUnconfigured()
    {
        ...
        await using MessageHubApplication application = CreateBuilder(typeof(MessageHubApplication).Assembly).Build();
    ...
    private static MessageHubApplicationBuilder CreateBuilder(Assembly assembly)
    {
        ...
        return (MessageHubApplicationBuilder)method.Invoke(null, [Array.Empty<string>(), assembly])!;
    }
