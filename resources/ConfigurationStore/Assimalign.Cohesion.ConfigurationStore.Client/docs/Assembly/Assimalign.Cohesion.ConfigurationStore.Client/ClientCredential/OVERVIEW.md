...
Credentials are bound when `ConfigurationStoreClient.Create` constructs a client. Item 25 can
create a new lightweight client for each reconciled credential while the underlying transport
remains shared.

## Links

- [Assembly overview](../OVERVIEW.md)
- [ConfigurationStoreClient](../ConfigurationStoreClient/OVERVIEW.md)
