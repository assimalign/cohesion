...
/// <summary>
/// Represents the ConfigurationStore application lifecycle without hosting dependencies.
/// </summary>
public interface IConfigurationStoreApplication
{
    /// <summary>
    /// Gets the application context.
    /// </summary>
    IConfigurationStoreApplicationContext Context { get; }
