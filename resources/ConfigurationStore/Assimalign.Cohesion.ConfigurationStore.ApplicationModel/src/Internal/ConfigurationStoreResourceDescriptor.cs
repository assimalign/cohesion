...
internal sealed class ConfigurationStoreResourceDescriptor : IConfigurationStoreResourceDescriptor
{
    private readonly IResourceCommandDescriptor _inner;

    internal ConfigurationStoreResourceDescriptor(IApplicationResourceDescriptor inner)
    {
    ...
    public IConfigurationStoreResourceDescriptor DependsOn(IApplicationResourceDescriptor resource)
    {
        _inner.DependsOn(resource);
        return this;
    }

    public IConfigurationStoreResourceDescriptor DependsOn(params IApplicationResourceDescriptor[] resources)
    {
