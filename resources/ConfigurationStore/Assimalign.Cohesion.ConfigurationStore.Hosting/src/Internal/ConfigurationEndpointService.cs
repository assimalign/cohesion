...
internal sealed class ConfigurationEndpointService : BackgroundService
{
    protected override async Task ExecuteAsync(CancellationToken cancellationToken)
    {
        // TODO: serve configuration reads and push change notifications. The placeholder parks until the host stops so the scaffolded
