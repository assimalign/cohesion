...
The area root owns only the contracts that feature packages compose against. `INatGatewayApplicationBuilder` is the contract-only builder seam, while `INatGatewayApplication` supplies the hosting-free application lifecycle.
