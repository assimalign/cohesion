...
/// <summary>
/// Represents the NatGateway application lifecycle without hosting dependencies.
/// </summary>
public interface INatGatewayApplication
{
    /// <summary>
    /// Gets the application context.
    /// </summary>
    INatGatewayApplicationContext Context { get; }
