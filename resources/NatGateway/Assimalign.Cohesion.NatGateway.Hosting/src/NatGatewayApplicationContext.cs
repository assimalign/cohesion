...
/// <summary>
/// Provides the NatGateway application environment and runtime composition.
/// </summary>
public sealed class NatGatewayApplicationContext : HostContext, INatGatewayApplicationContext, IHealthContributor
{
    private IReadOnlyList<IHostService> _hostedServices = Array.Empty<IHostService>();
    private readonly IHostEnvironment _environment;

    internal NatGatewayApplicationContext(ResourceContext? resourceContext = null)
    {
    ...
    public ValueTask<HealthContribution> CheckAsync(CancellationToken cancellationToken = default)
    {
        ...
        return ValueTask.FromResult(State is HostState.Failed
            ? HealthContribution.Unhealthy("The NatGateway host failed.")
