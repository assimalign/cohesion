...
public sealed class ResourceControlPlaneTests
{
    ...
    public async Task ControlPlane_WithEndpoint_ShouldServeProbesAndManagement(bool managed)
    {
        ...
        await using NatGatewayApplication application = CreateBuilder(typeof(ResourceControlPlaneTests).Assembly).Build();
    ...
    public async Task Build_WithoutRegistration_ShouldLeaveHostUnconfigured()
    {
        ...
        await using NatGatewayApplication application = CreateBuilder(typeof(NatGatewayApplication).Assembly).Build();
    ...
    private static NatGatewayApplicationBuilder CreateBuilder(Assembly assembly)
    {
        ...
        return (NatGatewayApplicationBuilder)method.Invoke(null, [Array.Empty<string>(), assembly])!;
    }
