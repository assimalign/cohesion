...
public sealed class ResourceControlPlaneTests
{
    ...
    public async Task ControlPlane_WithEndpoint_ShouldServeProbesAndManagement(bool managed)
    {
        ...
        await using IoTHubApplication application = CreateBuilder(typeof(ResourceControlPlaneTests).Assembly).Build();
    ...
    public async Task Build_WithoutRegistration_ShouldLeaveHostUnconfigured()
    {
        ...
        await using IoTHubApplication application = CreateBuilder(typeof(IoTHubApplication).Assembly).Build();
    ...
    private static IoTHubApplicationBuilder CreateBuilder(Assembly assembly)
    {
        ...
        return (IoTHubApplicationBuilder)method.Invoke(null, [Array.Empty<string>(), assembly])!;
    }
