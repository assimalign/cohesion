...
/// order — the same shape the real <c>WebApplication</c> builder produces — without pulling in the
/// hosting/DI stack.
/// </summary>
...
/// <summary>
/// A configurable <see cref="IHttpContext"/> test double with a readable response body.
/// </summary>
