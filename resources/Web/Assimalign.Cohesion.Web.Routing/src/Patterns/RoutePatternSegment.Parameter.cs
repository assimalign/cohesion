...
public sealed class RoutePatternParameterSegment : RoutePatternSegment
{
    public RoutePatternParameterSegment(
    ...
    public RoutePatternParameterSegment(
        ...
        RoutePatternParameterPolicyReference[] parameterPolicies,
        bool encodeSlashes)
        : base(RoutePatternSegmentKind.Parameter)
    {
    ...
    internal override string DebuggerToString()
    {
        ...
        {
            builder.Append(':');
            builder.Append(constraint.Content ?? constraint.ParameterPolicy?.ToString());
        }
