...
public class ProblemDetailsWriterTests
{
    ...
    [Fact(DisplayName = "Cohesion Test [Web.ProblemDetails] - ProblemDetailsWriter: omits absent optional members and defaults type to about:blank")]
    ...
    [Fact(DisplayName = "Cohesion Test [Web.ProblemDetails] - ProblemDetailsWriter: FromStatus fills type, title and status from the status code")]
    ...
    [Fact(DisplayName = "Cohesion Test [Web.ProblemDetails] - ProblemDetailsWriter: renders scalar, array and nested-object extensions")]
    ...
    [Fact(DisplayName = "Cohesion Test [Web.ProblemDetails] - ProblemDetailsWriter: ignores an extension that collides with a standard member")]
    ...
    [Fact(DisplayName = "Cohesion Test [Web.ProblemDetails] - ProblemDetailsWriter: null extension value renders as JSON null")]
    ...
    [Fact(DisplayName = "Cohesion Test [Web.ProblemDetails] - ProblemDetailsWriter: stream, byte and string forms all agree")]
