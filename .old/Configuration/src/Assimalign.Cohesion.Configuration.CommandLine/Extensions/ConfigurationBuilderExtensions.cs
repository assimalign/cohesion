...
namespace Assimalign.Cohesion.Configuration
{
    ...
    public static partial class ConfigurationBuilderExtensions
    {
        ...
        /// <summary>
        ///   Adds a <see cref="ConfigurationCommandLineProvider"/> <see cref="IConfigurationProvider"/>
        ...
        /// <summary>
        ///   Adds a <see cref="ConfigurationCommandLineProvider"/> <see cref="IConfigurationProvider"/> that reads
        ...
        {
            configurationBuilder.Add(new ConfigurationCommandLineSource { Args = args, SwitchMappings = switchMappings });
        ...
        /// <returns>The <see cref="IConfigurationBuilder"/>.</returns>
        public static IConfigurationBuilder AddCommandLine(this IConfigurationBuilder builder, Action<ConfigurationCommandLineSource> configureSource)
