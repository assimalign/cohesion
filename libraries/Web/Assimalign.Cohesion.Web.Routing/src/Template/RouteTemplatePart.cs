...
public class RouteTemplatePart
{
    ...
    public RouteTemplatePart(RoutePatternSegment other)
    {
        ...
        else if (other.IsParameter && other is RoutePatternParameterSegment parameter)
        {
            ...
            InlineConstraints = parameter.ParameterPolicies?.Select(p => new RouteTemplateInlineConstraint(p)) ?? Enumerable.Empty<RouteTemplateInlineConstraint>();
        }
    ...
    public RouteTemplatePart ToRoutePatternPart()
    {
