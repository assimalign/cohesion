...
public static class RoutePatternParameterParser
{
    ...
    public static RoutePatternParameterSegment ParseRouteParameter(string parameter)
    {
        ArgumentNullException.ThrowIfNull(parameter);

        if (parameter.Length == 0)
        {
            return new RoutePatternParameterSegment(string.Empty, null, RoutePatternParameterKind.Standard, Array.Empty<RoutePatternParameterPolicyReference>());
        }
        ...
        return new RoutePatternParameterSegment(
            parameterName,
            defaultValue,
            parameterKind,
