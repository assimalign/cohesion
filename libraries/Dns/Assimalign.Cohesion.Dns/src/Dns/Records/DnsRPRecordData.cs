...
namespace Assimalign.Cohesion.Dns.ResourceRecords
{
    ...
    public class DnsRPRecordData : DnsResourceRecordData
    {
        ...
        {
            _mailbox = DnsPacket.DeserializeDomainName(s, isEmailAddress: true);
            _txtDomain = DnsPacket.DeserializeDomainName(s);
        }

        protected override void WriteRecordData(Stream s, List<DnsDomainOffset> domainEntries, bool canonicalForm)
        {
            DnsPacket.SerializeDomainName(canonicalForm ? _mailbox.ToLowerInvariant() : _mailbox, s, isEmailAddress: true);
            DnsPacket.SerializeDomainName(canonicalForm ? _txtDomain.ToLowerInvariant() : _txtDomain, s);
        }
        ...
        { get { return DnsPacket.GetSerializeDomainNameLength(_mailbox) + DnsPacket.GetSerializeDomainNameLength(_txtDomain); } }
