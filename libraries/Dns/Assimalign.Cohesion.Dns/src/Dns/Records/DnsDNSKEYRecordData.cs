...
using Assimalign.Cohesion.Dns.Dnssec;
...
namespace Assimalign.Cohesion.Dns.ResourceRecords
{
    ...
    public class DnsDNSKEYRecordData : DnsResourceRecordData
    {
        ...
        public static bool IsAnyDnssecAlgorithmSupported(IReadOnlyList<DnsResourceRecord> dnsKeyRecords)
        {
            ...
            {
                if (record.Type != DnsRecordType.DNSKEY)
                    continue;
        ...
        private void Serialize()
        {
            ...
            {
                DnsPacket.WriteUInt16NetworkOrder((ushort)_flags, mS);
        ...
        {
            using (MemoryStream mS = new MemoryStream(DnsPacket.GetSerializeDomainNameLength(ownerName) + _rData.Length))
            {
        ...
        protected override void ReadRecordData(Stream s)
        {
            ...
            {
                _flags = (DnsDnsKeyFlag)DnsPacket.ReadUInt16NetworkOrder(mS);
