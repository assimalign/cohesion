...
namespace Assimalign.Cohesion.Dns.ResourceRecords
{
    public class DnsNSRecordData : DnsResourceRecordData
    {
        ...
        {
            _nameServer = DnsPacket.DeserializeDomainName(s);
        }

        protected override void WriteRecordData(Stream s, List<DnsDomainOffset> domainEntries, bool canonicalForm)
        {
            DnsPacket.SerializeDomainName(canonicalForm ? _nameServer.ToLowerInvariant() : _nameServer, s, domainEntries);
        }
        ...
        { get { return DnsPacket.GetSerializeDomainNameLength(_nameServer); } }
