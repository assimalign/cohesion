...
namespace Assimalign.Cohesion.Dns.EDnsOptions
{
    ...
    public class EDnsClientSubnetOptionData : EDnsOptionData
    {
        ...
        {
            _family = (EDnsClientSubnetAddressFamily)DnsPacket.ReadUInt16NetworkOrder(s);
        ...
        {
            DnsPacket.WriteUInt16NetworkOrder((ushort)_family, s);
