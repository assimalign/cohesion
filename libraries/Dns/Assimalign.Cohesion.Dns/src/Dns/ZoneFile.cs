...
namespace Assimalign.Cohesion.Dns
{
    public class ZoneFile
    {
        ...
        internal async Task<Stream> GetRData()
        {
            ...
            {
                DnsPacket.WriteUInt16NetworkOrder(rdLength, mS);
                mS.Write(data);
                mS.Position = 0;
            }
        ...
        private async Task<DnsResourceRecordData> ParseRecordDataAsync(DnsRecordType type)
        {
            switch (type)
            {
