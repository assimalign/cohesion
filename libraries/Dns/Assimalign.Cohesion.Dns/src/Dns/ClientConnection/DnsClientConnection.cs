...
namespace Assimalign.Cohesion.Dns.ClientConnection
{
    public abstract class DnsClientConnection : IDisposable, IAsyncDisposable
    {
        ...
        protected readonly DnsNsAddress _server;
        ...
        static readonly ConcurrentDictionary<DnsNsAddress, ConcurrentDictionary<NetProxy, TcpClientConnection>> _existingTcpConnections = new ConcurrentDictionary<DnsNsAddress, ConcurrentDictionary<NetProxy, TcpClientConnection>>();
        static readonly ConcurrentDictionary<DnsNsAddress, ConcurrentDictionary<NetProxy, TlsClientConnection>> _existingTlsConnections = new ConcurrentDictionary<DnsNsAddress, ConcurrentDictionary<NetProxy, TlsClientConnection>>();
        static readonly ConcurrentDictionary<DnsNsAddress, ConcurrentDictionary<NetProxy, HttpsClientConnection>> _existingHttpsConnections = new ConcurrentDictionary<DnsNsAddress, ConcurrentDictionary<NetProxy, HttpsClientConnection>>();
        static readonly ConcurrentDictionary<DnsNsAddress, ConcurrentDictionary<NetProxy, QuicClientConnection>> _existingQuicConnections = new ConcurrentDictionary<DnsNsAddress, ConcurrentDictionary<NetProxy, QuicClientConnection>>();
        ...
        static DnsClientConnection()
        {
            _maintenanceTimer = new Timer(async delegate (object state)
            {
                try
                {
                    ...
                    foreach (KeyValuePair<DnsNsAddress, ConcurrentDictionary<NetProxy, TcpClientConnection>> existingTcpConnection in _existingTcpConnections)
                    {
                    ...
                    foreach (KeyValuePair<DnsNsAddress, ConcurrentDictionary<NetProxy, TlsClientConnection>> existingTlsConnection in _existingTlsConnections)
                    {
                    ...
                    foreach (KeyValuePair<DnsNsAddress, ConcurrentDictionary<NetProxy, HttpsClientConnection>> existingHttpsConnection in _existingHttpsConnections)
                    {
                    ...
                    foreach (KeyValuePair<DnsNsAddress, ConcurrentDictionary<NetProxy, QuicClientConnection>> existingQuicConnection in _existingQuicConnections)
                    {
        ...
        protected DnsClientConnection(DnsNsAddress server, NetProxy proxy)
        {
            _server = server;
            _proxy = proxy;
        }
        ...
        public static DnsClientConnection GetConnection(DnsNsAddress server, NetProxy proxy)
        {
            switch (server.Protocol)
            {
                ...
                case DnsTransportProtocol.Tcp:
                    {
                        ConcurrentDictionary<NetProxy, TcpClientConnection> existingTcpConnection = _existingTcpConnections.GetOrAdd(server, delegate (DnsNsAddress nameServer)
                        {
                ...
                case DnsTransportProtocol.Tls:
                    {
                        ConcurrentDictionary<NetProxy, TlsClientConnection> existingTlsConnection = _existingTlsConnections.GetOrAdd(server, delegate (DnsNsAddress nameServer)
                        {
                ...
                case DnsTransportProtocol.Https:
                    {
                        ConcurrentDictionary<NetProxy, HttpsClientConnection> existingHttpsConnection = _existingHttpsConnections.GetOrAdd(server, delegate (DnsNsAddress nameServer)
                        {
                ...
                case DnsTransportProtocol.Quic:
                    {
                        ConcurrentDictionary<NetProxy, QuicClientConnection> existingQuicConnection = _existingQuicConnections.GetOrAdd(server, delegate (DnsNsAddress nameServer)
                        {
        ...
        protected static void ValidateResponse(DnsPacket request, DnsPacket response)
        {
        ...
        public abstract Task<DnsPacket> QueryAsync(DnsPacket request, int timeout, int retries, CancellationToken cancellationToken);

        #endregion

        #region properties

        public DnsNsAddress Server
        { get { return _server; } }
