...
namespace Assimalign.Cohesion.Dns
{
    ...
    public class DnsPacketQuestion
    {
        ...
        public DnsPacketQuestion(string name, DnsRecordType type, DnsClass @class, bool validateName = true)
        {
        ...
        public DnsPacketQuestion(IPAddress ip, DnsClass @class)
        {
        ...
        public DnsPacketQuestion(Stream s)
        {
        ...
        public DnsPacketQuestion(JsonElement jsonQuestionRecord)
        {
            _name = jsonQuestionRecord.GetProperty("name").GetString().TrimEnd('.');
            _type = (DnsRecordType)jsonQuestionRecord.GetProperty("type").GetUInt16();
            _class = DnsClass.Internet;
        }
        ...
        internal DnsPacketQuestion Clone()
        {
            return new DnsPacketQuestion(_name, _type, _class) { _zoneCut = _zoneCut, _minimizedName = _minimizedName };
        }
        ...
        public void WriteTo(Stream s, List<DnsDomainOffset> domainEntries)
        {
            ...
            {
                DnsPacket.SerializeDomainName(_minimizedName, s, domainEntries);
                DnsPacket.WriteUInt16NetworkOrder((ushort)MinimizedType, s);
                DnsPacket.WriteUInt16NetworkOrder((ushort)_class, s);
            }
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj is DnsPacketQuestion other)
            {
        ...
        internal DnsRecordType MinimizedType
        {
            get
            {
                switch (_type)
