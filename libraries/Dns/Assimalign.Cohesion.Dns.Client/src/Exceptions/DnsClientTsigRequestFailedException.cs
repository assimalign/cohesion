...
{
    public class DnsClientTsigRequestFailedException : DnsClientException
    {
        #region variables
        ...
        public DnsClientTsigRequestFailedException(DnsResponseCode rCode, DnsTsigError error, string message)
            : base(message)
        {
            _rCode = rCode;
            _error = error;
