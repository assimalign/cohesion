...
public class AmqpClientTransportTests
{
    ...
    [Fact(DisplayName = "Cohesion Test [Amqp.Connections] - ConnectAsync: Should yield a tracked AMQP connection over a single-stream carrier")]
    ...
    [Fact(DisplayName = "Cohesion Test [Amqp.Connections] - OpenAsync: Should open a bidirectional carrier stream on a multiplexed carrier")]
    ...
    [Fact(DisplayName = "Cohesion Test [Amqp.Connections] - ConnectAsync: Should throw after the transport is disposed")]
    ...
    [Fact(DisplayName = "Cohesion Test [Amqp.Connections] - DisposeAsync: Should dispose tracked client connections")]
    ...
    [Fact(DisplayName = "Cohesion Test [Amqp.Connections] - DisposeAsync: Should tear down the carrier stream and the multiplexed carrier")]
