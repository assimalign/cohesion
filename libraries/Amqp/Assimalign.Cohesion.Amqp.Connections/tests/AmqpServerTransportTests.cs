...
public class AmqpServerTransportTests
{
    ...
    [Fact(DisplayName = "Cohesion Test [Amqp.Connections] - AcceptAsync: Should yield a tracked AMQP connection over a single-stream carrier")]
    ...
    [Fact(DisplayName = "Cohesion Test [Amqp.Connections] - OpenAsync: Should wire the context to the carrier connection's pipes")]
    ...
    [Fact(DisplayName = "Cohesion Test [Amqp.Connections] - OpenAsync: Should return the same context on repeated opens")]
    ...
    [Fact(DisplayName = "Cohesion Test [Amqp.Connections] - AcceptAsync: Should accept the carrier stream from the peer on a multiplexed carrier")]
    ...
    [Fact(DisplayName = "Cohesion Test [Amqp.Connections] - AcceptAsync: Should throw after the transport is disposed")]
    ...
    [Fact(DisplayName = "Cohesion Test [Amqp.Connections] - DisposeAsync: Should dispose tracked connections and the owned listener")]
    ...
    [Fact(DisplayName = "Cohesion Test [Amqp.Connections] - DisposeAsync: Should untrack the connection and tear down its carrier")]
    ...
    [Fact(DisplayName = "Cohesion Test [Amqp.Connections] - Abort: Should abort the carrier connection")]
