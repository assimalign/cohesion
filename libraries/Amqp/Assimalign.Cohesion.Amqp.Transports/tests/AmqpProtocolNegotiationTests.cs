...
public class AmqpProtocolNegotiationTests
{
    ...
    [Fact(DisplayName = "Cohesion Test [Amqp.Transports] - OpenAsync: Should exchange protocol headers when auto-negotiation is enabled")]
    ...
    [Fact(DisplayName = "Cohesion Test [Amqp.Transports] - OpenAsync: Should not exchange bytes until NegotiateAsync when auto-negotiation is disabled")]
    ...
    [Fact(DisplayName = "Cohesion Test [Amqp.Transports] - NegotiateAsync: Should return the cached remote header on repeated calls")]
    ...
    [Fact(DisplayName = "Cohesion Test [Amqp.Transports] - SwitchProtocolAsync: Should negotiate the next protocol phase after SASL")]
    ...
    [Fact(DisplayName = "Cohesion Test [Amqp.Transports] - OpenAsync: Should negotiate both sides over cross-wired carrier peers")]
    ...
    [Fact(DisplayName = "Cohesion Test [Amqp.Transports] - OpenAsync: Should surface a protocol error when the remote header is truncated")]
