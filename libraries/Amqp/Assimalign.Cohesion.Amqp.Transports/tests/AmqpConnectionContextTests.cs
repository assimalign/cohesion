...
public class AmqpConnectionContextTests
{
    ...
    [Fact(DisplayName = "Cohesion Test [Amqp.Transports] - ReceiveAsync: Should decode an inbound open performative after negotiation")]
    ...
    [Fact(
        DisplayName = "Cohesion Test [Amqp.Transports] - ReceiveAsync: Should decode a frame that arrives coalesced with the protocol header",
    ...
    [Fact(DisplayName = "Cohesion Test [Amqp.Transports] - SendAsync: Should write the encoded begin frame to the carrier")]
    ...
    [Fact(DisplayName = "Cohesion Test [Amqp.Transports] - AsStream: Should round-trip bytes over the carrier connection")]
    ...
    [Fact(DisplayName = "Cohesion Test [Amqp.Transports] - SendAsync: Should require negotiation when auto-negotiation is disabled")]
    ...
    [Fact(DisplayName = "Cohesion Test [Amqp.Transports] - ReceiveAsync: Should require negotiation when auto-negotiation is disabled")]
    ...
    [Fact(DisplayName = "Cohesion Test [Amqp.Transports] - ReceiveAsync: Should surface a protocol error when the carrier ends mid-frame")]
    ...
    [Fact(DisplayName = "Cohesion Test [Amqp.Transports] - SendAsync: Should reject frames exceeding the configured maximum frame size")]
