...
/// parent's <see cref="ParentId"/> as their <see cref="ILogEntry.ParentId"/>.
/// </summary>
/// <remarks>
/// <para>
/// Scoped loggers are obtained from <see cref="ILogger.BeginScope(ILogEntry)"/>. Disposing the
/// scoped logger closes the scope; calling <see cref="IDisposable.Dispose"/> more than once is a
/// no-op. Scopes can nest: calling <see cref="ILogger.BeginScope(ILogEntry)"/> on an
