...
public sealed class ConfigurationManager : IConfigurationManager
{
    ...
    public ConfigurationManager AddProvider(Func<IConfigurationBuilderContext, Task<IConfigurationProvider>> configure)
    {
        ...
        return AddProviderAsync(configure)
            .ConfigureAwait(false)
            .GetAwaiter()
            .GetResult();
    }
    ...
    private async ValueTask<ConfigurationManager> AddProviderAsync(
    ...
    ValueTask<IConfiguration> IConfigurationBuilder.BuildAsync(CancellationToken cancellationToken)
    {
        return ValueTask.FromResult<IConfiguration>(this);
    }
}
