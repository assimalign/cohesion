...
aggregation surface used by enabled resource executables. Resource and reference endpoints are
represented by `System.Uri` throughout that ambient and control-plane surface. Generated resource
module initializers
