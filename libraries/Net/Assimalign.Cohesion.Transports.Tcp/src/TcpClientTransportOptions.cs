...
{
    private readonly TransportPipelineBuilder<TcpTransportConnectionContext> _builder;
    private readonly Lazy<TransportPipeline<TcpTransportConnectionContext>> _pipeline;

    public TcpClientTransportOptions()
    {
        _builder = new TransportPipelineBuilder<TcpTransportConnectionContext>();
        _pipeline = new Lazy<TransportPipeline<TcpTransportConnectionContext>>(() => _builder.Build());
    }
    ...
    /// 
    /// </summary>
    internal TransportPipeline<TcpTransportConnectionContext> Pipeline => _pipeline.Value;
	...
	/// <returns></returns>
    public TcpClientTransportOptions Use(Func<TcpTransportConnectionContext, TransportMiddleware, Task> middleware)
    {
    ...
    internal TcpTransportConnectionSettings CreateConnectionSettings()
    {
