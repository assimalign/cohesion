...
internal class SocketTransportConnectionContext : ITransportConnectionContext, IThreadPoolWorkItem
{
    ...
    public SocketTransportConnectionContext(TcpTransportConnectionSettings? settings)
    {
        if (settings is null)
        {
    ...
    public CancellationToken ConnectionCancelled => throw new NotImplementedException();
