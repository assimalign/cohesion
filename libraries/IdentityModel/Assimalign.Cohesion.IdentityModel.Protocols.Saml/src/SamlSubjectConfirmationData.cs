...
/// constrains how and where a subject confirmation is valid.
/// </summary>
public sealed class SamlSubjectConfirmationData
{
    ...
    /// </summary>
    /// <param name="recipient">The URI the confirmation is addressed to (the service provider's assertion consumer URL).</param>
    ...
    /// <summary>
    /// Gets the verbatim <c>KeyInfo</c> XML for holder-of-key confirmations. Cryptographic
    /// use is the token package's concern; this preserves the reference descriptively.
    /// </summary>
