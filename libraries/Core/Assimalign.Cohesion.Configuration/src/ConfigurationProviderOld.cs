...
/// </summary>
public abstract class ConfigurationProviderOld : IConfigurationProvider
{
    ...
    /// </summary>
    protected ConfigurationProviderOld()
    {
    ...
    /// </summary>
    protected virtual IDictionary<Key, object> Data { get;}
    ...
    public virtual IEnumerable<string> GetChildKeys(IEnumerable<string> earlierKeys, string parentPath)
    {
        ...
        {
            Debug.Assert(ConfigurationPathHelper.KeyDelimiter == ":");
    ...
    {
        int indexOf = key.IndexOf(ConfigurationPathHelper.KeyDelimiter, prefixLength, StringComparison.OrdinalIgnoreCase);
