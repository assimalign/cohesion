...
/// <summary>
/// Extensions for adding retries to <see cref="ResiliencePipelineBuilderO"/>.
/// </summary>
public static class RetryResiliencePipelineBuilderExtensions
{
    ...
    public static ResiliencePipelineBuilderO AddRetry(this ResiliencePipelineBuilderO builder, RetryStrategyOptions options)
    {
    ...
    [UnconditionalSuppressMessage(
        ...
        "IL2026:Members annotated with 'RequiresUnreferencedCodeAttribute' require dynamic access otherwise can break functionality when trimming application code",
        Justification = "All options members preserved.")]
    public static ResiliencePipelineBuilderO<TResult> AddRetry<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] TResult>(
