...
public sealed class RetryStrategyOptions
{
    ...
    /// </value>
    public Func<RetryPredicateArguments, ValueTask<bool>> ShouldHandle { get; set; } = args => new ValueTask<bool>(!args.Outcome.IsError<OperationCanceledException>(out var _));
    ...
    /// The default value is <see langword="null"/>.
    /// </value>
    public Func<RetryDelayGeneratorArguments, ValueTask<TimeSpan?>>? DelayGenerator { get; set; }
    ...
    /// The default value is <see langword="null"/>.
    /// </value>
    public Func<OnRetryArguments, ValueTask>? OnRetry { get; set; }
