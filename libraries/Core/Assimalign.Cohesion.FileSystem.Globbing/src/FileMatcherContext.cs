...
public class FileMatcherContext
{
    ...
    private void Match(IFileSystemDirectory directory, string parentRelativePath)
    {
        ...
        foreach (var fileInfo in entities)
        {
            ...
            {
                FilePatternTestResult result = MatchPatternContexts(fileInfo, (pattern, file) => pattern.Test((file as IFileSystemFile)!));
    ...
    private bool MatchPatternContexts(IFileSystemInfo fileinfo, Func<IFilePatternContext, IFileSystemInfo, bool> test) 
    {
    ...
    private FilePatternTestResult MatchPatternContexts(IFileSystemInfo fileinfo, Func<IFilePatternContext, IFileSystemInfo, FilePatternTestResult> test) 
    {
