...
//        : this(maxDynamicTableSize, maxHeadersLength, new HPackDynamicTable(maxDynamicTableSize))
//    {
//    }

//    // For testing.
//    internal HPackDecoder(int maxDynamicTableSize, int maxHeadersLength, HPackDynamicTable dynamicTable)
//    {
...
//    {
//        // Parse remaining chars, up to the length of the current data
