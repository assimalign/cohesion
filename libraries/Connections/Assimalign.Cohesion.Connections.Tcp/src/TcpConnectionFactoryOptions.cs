...
/// <summary>
/// Provides socket-tuning options for <see cref="TcpConnectionFactory"/>.
/// </summary>
public sealed class TcpConnectionFactoryOptions
{
    /// <summary>
    ...
    /// The default options.
    /// </summary>
    public static TcpConnectionFactoryOptions Default { get; } = new TcpConnectionFactoryOptions();
}
