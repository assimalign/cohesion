...
/// (<c>HttpConnectionListenerOptions.Interceptors</c>), the same way
...
public static class HttpResponseStreaming
{
    ...
    public static IHttpExchangeInterceptor CreateInterceptor() => new HttpResponseStreamingInterceptor();
}
