...
internal sealed class HttpServerOptionsInternal : HttpConnectionListenerOptions
{
    ...
    private void ValidateTransport(ITransport transport)
    {
        ...
        if (transport.Protocol != ProtocolType.Tcp && transport.Protocol != ProtocolType.Quic)
        {
