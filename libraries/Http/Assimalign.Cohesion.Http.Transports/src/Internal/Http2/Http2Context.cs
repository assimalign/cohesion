...
{
    public Http2Context(Http2Stream stream, Http2Request request, Http2Response response, IHttpConnectionInfo connectionInfo, CancellationToken requestAborted)
