...
public readonly struct HttpQuality : IEquatable<HttpQuality>, IComparable<HttpQuality>
{
    ...
    private HttpQuality(int perMille) => this._perMille = perMille;
    ...
    /// <inheritdoc />
    public bool Equals(HttpQuality other) => _perMille == other._perMille;

    /// <inheritdoc />
    public int CompareTo(HttpQuality other) => _perMille.CompareTo(other._perMille);

    /// <inheritdoc />
    public override bool Equals(object? obj) => obj is HttpQuality other && Equals(other);

    /// <inheritdoc />
    public override int GetHashCode() => _perMille;

    /// <inheritdoc />
    public override string ToString() => DebuggerDisplay;

    /// <summary>Determines whether two weights are equal.</summary>
    public static bool operator ==(HttpQuality left, HttpQuality right) => left._perMille == right._perMille;
