...
{
    internal ResilienceStrategyTelemetry(ResilienceEventSource source, ResilienceTelemetryListener? listener)
    {
    ...
    internal ResilienceTelemetryListener? Listener { get; }
    internal ResilienceEventSource TelemetrySource { get; }
    ...
    public void Report<TArgs>(ResilienceEvent resilienceEvent, ResilienceContextO context, TArgs args)
    {
    ...
    /// <param name="args">The event arguments.</param>
    public void Report<TArgs, TResult>(ResilienceEvent resilienceEvent, ResilienceContextO context, OutcomeO<TResult> outcome, TArgs args)
    {
        if (Listener is null || resilienceEvent.Severity == ResilienceEventSeverity.None)
        {
            return;
