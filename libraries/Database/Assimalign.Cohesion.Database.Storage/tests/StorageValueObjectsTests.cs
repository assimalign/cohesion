...
{
    [Fact]
    [DisplayName("Cohesion Test [Name] - Equality: Should compare by ordinal value")]
    ...
    [Fact]
    [DisplayName("Cohesion Test [PageId] - Conversion: Should roundtrip long conversions")]
    ...
    [Fact]
    [DisplayName("Cohesion Test [StorageId] - NewId: Should produce unique values")]
    ...
    [Fact]
    [DisplayName("Cohesion Test [Address] - Append: Should grow path and compute offset")]
    ...
    [Fact]
    [DisplayName("Cohesion Test [Address] - GetOffset: Should throw for invalid depth")]
