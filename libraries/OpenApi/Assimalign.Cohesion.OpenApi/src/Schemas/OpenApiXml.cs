...
public sealed class OpenApiXml : IOpenApiExtensible
{
    ...
    /// <summary>Gets or sets a value indicating whether the property is represented as an attribute rather than an element.</summary>
    public bool Attribute { get; set; }

    /// <summary>Gets or sets a value indicating whether an array is wrapped in a containing element.</summary>
